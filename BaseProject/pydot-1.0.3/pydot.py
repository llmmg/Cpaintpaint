...
#everything is unicode node_prefix= u'' is replaced
...
class Dot(Graph):
    ...
    def write(self, path, prog=None, format='raw'):
        ...
        if format == 'raw':
            dot_fd.write(self.to_string().encode("Latin-1"))
        else:
            dot_fd.write(self.create(prog, format).encode("Latin"))
        dot_fd.close()
    ...
    def create(self, prog=None, format='ps'):
        ...
        stdout_output = ''.join(e.decode("Latin-1") for e in stdout_output)
