...
_lr_action_items = {'(':([1,5,8,9,13,18,19,],[8,8,8,8,8,8,8,]),'PRINT':([0,14,22,],[1,1,1,]),'ADD_OP':([1,5,8,9,10,11,12,13,15,16,17,18,19,20,23,24,25,],[9,9,9,9,-10,-9,19,9,19,19,-12,9,9,19,-11,-8,-7,]),'IDENTIFIER':([0,1,5,8,9,13,14,18,19,22,],[2,10,10,10,10,10,2,10,10,2,]),'MUL_OP':([10,11,12,15,16,17,20,23,24,25,],[-10,-9,18,18,18,-12,18,-11,-8,18,]),'WHILE':([0,14,22,],[5,5,5,]),';':([3,4,6,10,11,12,17,20,23,24,25,27,],[-3,14,-4,-10,-9,-5,-12,-13,-11,-8,-7,-6,]),'=':([2,],[13,]),')':([10,11,16,17,23,24,25,],[-10,-9,23,-12,-11,-8,-7,]),'{':([10,11,15,17,23,24,25,],[-10,-9,22,-12,-11,-8,-7,]),'NUMBER':([1,5,8,9,13,18,19,],[11,11,11,11,11,11,11,]),'}':([3,4,6,10,11,12,17,20,21,23,24,25,26,27,],[-3,-1,-4,-10,-9,-5,-12,-13,-2,-11,-8,-7,27,-6,]),'$end':([3,4,6,7,10,11,12,17,20,21,23,24,25,27,],[-3,-1,-4,0,-10,-9,-5,-12,-13,-2,-11,-8,-7,-6,]),}
...
_lr_goto_items = {'structure':([0,14,22,],[6,6,6,]),'assignation':([0,14,22,],[3,3,3,]),'expression':([1,5,8,9,13,18,19,],[12,15,16,17,20,24,25,]),'statement':([0,14,22,],[4,4,4,]),'programme':([0,14,22,],[7,21,26,]),}
